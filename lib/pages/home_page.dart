...
class HomePage extends StatelessWidget {
  ...
  static final List<_MenuData> _menus = [
    ...
    _MenuData('Total Input', Icons.add_circle_outline_rounded, const Color(0xFFFFF3E0), const Color(0xFFE65100), const SumInputPage(), 'Jumlah input'),
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildDrawerItem(context, icon: Icons.add_circle_outline_rounded, title: 'Jumlah Total Input', page: const SumInputPage(), iconColor: const Color(0xFFE65100)),
                  ...
                  _buildDrawerItem(context, icon: Icons.nights_stay_rounded, title: 'Hitung Weton', page: const WetonPage(), iconColor: const Color(0xFF6A1B9A)),
                  ...
                  _buildDrawerItem(context, icon: Icons.mosque_rounded, title: 'Konversi Hijriyah', page: const HijriConverterPage(), iconColor: const Color(0xFF1A237E)),
                  const Divider(height: 24),
                ],
              ),
            ),
